...
class DataGenerator : public RootData {
	...
	public:
		...
		void setDefaults() {
			...
			this->partDuplicationFactor = 20000;
		...
		DataGenerator(string scaleFactor, int serializationType) {
			...
			this->prepareData(serializationType);
		}
	...
	private:
		...
		void prepareHandCodedData() {
			prepareCommonData();
		}

		void prepareInPlaceData() {
			prepareCommonData();
		}


		// Will prepare Boost Objects:
		void prepareBoostData() {
			// All files to parse:
			string PartFile = "tables_scale_" + scaleFactor + "/part.tbl";
			string SupplierFile = "tables_scale_" + scaleFactor + "/supplier.tbl";
			string OrderFile = "tables_scale_" + scaleFactor + "/orders.tbl";
		...
		void prepareData(int serializationType) {
			switch(serializationType){
				case 0:
					prepareHandCodedData(); 
					break;
				case 1:
					prepareProtoData(); 
					break;
